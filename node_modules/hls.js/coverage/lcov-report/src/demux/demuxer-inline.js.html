...
class DemuxerInline {
&nbsp;
<span class="fstat-no" title="function not covered" >  constructor(</span>observer, typeSupported, config, vendor) <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
  destroy() {
    v</span>ar demuxer = <span class="cstat-no" title="statement not covered" >this.demuxer;
...
<span class="cstat-no" title="statement not covered" >    if ((data.byteLength &gt; 0) &amp;&amp; (decryptdata != null) &amp;&amp; (decryptdata.key != null) &amp;&amp; (decryptdata.method === 'AES-128')) {</span>
      l</span>et decrypter = <span class="cstat-no" title="statement not covered" >this.decrypter;
...
<span class="cstat-no" title="statement not covered" >        decrypter = this.decrypter = new Decrypter(this.observer, this.config);</span>
      ...
      v</span>ar localthis = <span class="cstat-no" title="statement not covered" >this;
...
<span class="cstat-no" title="statement not covered" >      decrypter.decrypt(data, decryptdata.key.buffer, decryptdata.iv.buffer, <span class="fstat-no" title="function not covered" >function (</span>decryptedData) {</span>
        var endTime;
<span class="cstat-no" title="statement not covered" >        try {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!demuxer ||</span>
      ...
      c</span>onst observer = <span class="cstat-no" title="statement not covered" >this.observer;
      c</span>onst typeSupported = <span class="cstat-no" title="statement not covered" >this.typeSupported;
      c</span>onst config = <span class="cstat-no" title="statement not covered" >this.config;
      // probing order is AAC/MP3/TS/MP4
      c</span>onst muxConfig = <span class="cstat-no" title="statement not covered" >[{ demux: AACDemuxer, remux: MP4Remuxer },
...
<span class="cstat-no" title="statement not covered" >      for (let i = 0, len = muxConfig.length; i &lt; len; i++) {</span>
        c</span>onst mux = <span class="cstat-no" title="statement not covered" >muxConfig[i];
        c</span>onst probe = <span class="cstat-no" title="statement not covered" >mux.demux.probe;
<span class="cstat-no" title="statement not covered" >        if (probe(data)) {</span>
          c</span>onst remuxer = <span class="cstat-no" title="statement not covered" >this.remuxer = new mux.remux(observer, config, typeSupported, this.vendor);
...
<span class="cstat-no" title="statement not covered" >      this.demuxer = demuxer;</span>
    ...
    c</span>onst remuxer = <span class="cstat-no" title="statement not covered" >this.remuxer;
&nbsp;

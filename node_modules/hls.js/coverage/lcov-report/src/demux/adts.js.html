...
&nbsp;
const ADTS = {
  getAudioConfig: <span class="fstat-no" title="function not covered" >function (</span>observer, data, offset, audioCodec) {
...
&nbsp;
  isHeaderPattern: <span class="fstat-no" title="function not covered" >function (</span>data, offset) {
<span class="cstat-no" title="statement not covered" >    return data[offset] === 0xff &amp;&amp; (data[offset + 1] &amp; 0xf6) === 0xf0;</span>
  },
&nbsp;
  getHeaderLength: <span class="fstat-no" title="function not covered" >function (</span>data, offset) {
<span class="cstat-no" title="statement not covered" >    return (!!(data[offset + 1] &amp; 0x01) ? 7 : 9);</span>
  },
&nbsp;
  getFullFrameLength: <span class="fstat-no" title="function not covered" >function (</span>data, offset) {
<span class="cstat-no" title="statement not covered" >    return ((data[offset + 3] &amp; 0x03) &lt;&lt; 11) |</span>
      (data[offset + 4] &lt;&lt; 3) |
      ((data[offset + 5] &amp; 0xE0) &gt;&gt;&gt; 5);
  },
&nbsp;
  isHeader: <span class="fstat-no" title="function not covered" >function (</span>data, offset) {
...
&nbsp;
  probe: <span class="fstat-no" title="function not covered" >function (</span>data, offset) {
    // same as isHeader but we also check that ADTS frame follows last ADTS frame 
    // or end of data is reached
<span class="cstat-no" title="statement not covered" >    if (offset + 1 &lt; data.length &amp;&amp; this.isHeaderPattern(data, offset)) {</span>
      // ADTS header Length
      l</span>et headerLength = <span class="cstat-no" title="statement not covered" >this.getHeaderLength(data, offset);
      // ADTS frame Length
      l</span>et frameLength = <span class="cstat-no" title="statement not covered" >headerLength;
<span class="cstat-no" title="statement not covered" >      if (offset + 5 &lt; data.length) {</span>
<span class="cstat-no" title="statement not covered" >        frameLength = this.getFullFrameLength(data, offset);</span>
      }
      l</span>et newOffset = <span class="cstat-no" title="statement not covered" >offset + frameLength;
...
&nbsp;
  initTrackConfig: <span class="fstat-no" title="function not covered" >function (</span>track, observer, data, offset, audioCodec) {
<span class="cstat-no" title="statement not covered" >    if (!track.samplerate) {</span>
      v</span>ar config = <span class="cstat-no" title="statement not covered" >this.getAudioConfig(observer, data, offset, audioCodec);
...
&nbsp;
  getFrameDuration: <span class="fstat-no" title="function not covered" >function (</span>samplerate) {
<span class="cstat-no" title="statement not covered" >    return 1024 * 90000 / samplerate;</span>
  },
&nbsp;
  appendFrame: <span class="fstat-no" title="function not covered" >function (</span>track, data, offset, pts, frameIndex) {
    v</span>ar frameDuration = <span class="cstat-no" title="statement not covered" >this.getFrameDuration(track.samplerate);
    v</span>ar header = <span class="cstat-no" title="statement not covered" >this.parseFrameHeader(data, offset, pts, frameIndex, frameDuration);
<span class="cstat-no" title="statement not covered" >    if (header) {</span>
      v</span>ar stamp = <span class="cstat-no" title="statement not covered" >header.stamp;
      v</span>ar headerLength = <span class="cstat-no" title="statement not covered" >header.headerLength;
      v</span>ar frameLength = <span class="cstat-no" title="statement not covered" >header.frameLength;
&nbsp;
      //logger.log(`AAC frame, offset/length/total/pts:${offset+headerLength}/${frameLength}/${data.byteLength}/${(stamp/90).toFixed(0)}`);
      v</span>ar aacSample = <span class="cstat-no" title="statement not covered" >{ unit: data.subarray(offset + headerLength, offset + headerLength + frameLength), pts: stamp, dts: stamp };
&nbsp;
...
&nbsp;
  parseFrameHeader: <span class="fstat-no" title="function not covered" >function (</span>data, offset, pts, frameIndex, frameDuration) {
    var headerLength, frameLength, stamp;
    v</span>ar length = <span class="cstat-no" title="statement not covered" >data.length;
&nbsp;
    // The protection skip bit tells us if we have 2 bytes of CRC data at the end of the ADTS header
<span class="cstat-no" title="statement not covered" >    headerLength = this.getHeaderLength(data, offset);</span>
    // retrieve frame size
<span class="cstat-no" title="statement not covered" >    frameLength = this.getFullFrameLength(data, offset);</span>
